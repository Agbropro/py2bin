"""py2bin – Python-to-binary CLI entry point.
...
from py2bin.schemas.schemas import Py2BinConfig
...
def main(argv: list[str] | None = None) -> int:
    ...
    if result.success:
        ...
        print(f"\n[py2bin] Build FAILED at stage(s): {result.stages_completed}", file=sys.stderr)
